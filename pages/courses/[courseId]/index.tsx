  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center content-center items-center">
        {lessons.map(
          ({ number, description, background, rating, completed }) => (
            <div
              key={number}
            ...
            >
              ...
              <div className="flex justify-between items-center py-3 px-4">
                ...
                <Link href={`/courses/${courseName}/${number}`}>
...
const LESSONS: Lesson[] = [
  {
    ...
    rating: 4,
    completed: true,
    background: "linear-gradient(121.32deg, #B993D6 0%, #8CA6DB 100%)",
  },
  {
    number: "2",
    description: ": and {",
    rating: 3,
    completed: true,
    background: "linear-gradient(121.32deg, #F2709C 0%, #FF9472 100%)",
  },
  {
    number: "3",
    description: "< and >",
    rating: 2,
    completed: true,
    background: "linear-gradient(121.32deg, #67B26F 0%, #4CA2CD 100%)",
  },
  {
    number: "4",
    description: ". and (",
    rating: 0,
    completed: false,
    background: "linear-gradient(121.32deg, #F3904F 0%, #3B4371 100%)",
  },
];
