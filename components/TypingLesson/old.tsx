...
import LessonContent from "classes/client/LessonContent";
...
class TypingLesson extends Component<Props, State> {
  ...
  async onLessonFinish(): Promise<void> {
    ...
    const data = new URL("/results", "http://localhost:3000");
    // data.searchParams.append("userId", this.context.user?.uid ?? "");
    ...
    // data.searchParams.set("dateStarted", dateStarted);
